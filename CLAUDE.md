...
**Phase 2 (bench-test): in progress, live breadboard debugging underway.** Conditioning circuit breadboarded; Stage A tuning in progress. Real-radio validation (originally Stage B) moved to Phase 3 — the car's RCA wiring isn't practically accessible without opening up the already-installed system.
