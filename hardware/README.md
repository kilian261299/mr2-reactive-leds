...
**`v2` (planned) adds the audio-reactive circuit** — R1–R6, D1, C1, and a new RCA input connector — directly onto the same board, replacing the standalone-breakout-board approach originally planned. See [docs/audio-reactive-led-plan.md](../docs/audio-reactive-led-plan.md), Phase 3, for the full checklist. Not yet designed.
