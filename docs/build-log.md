...
- **The maths behind C4/R5 and the diode margin** — worked through in `docs/audio-reactive-led-plan.md` and `hardware/audio-breakout.md` — confirm C4/R5 barely attenuate the signal (~99.5% passes even at 20Hz, since R5's 100kΩ dominates the divider) and that both diode options clear the ADC's 3.3V ceiling with real margin against the confirmed radio voltage.
